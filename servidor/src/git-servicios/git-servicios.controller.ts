...
export class GitServiciosController {
    ...
    async obtenerUsuarios(
        ...
        if (!CONFIGURACION.offline) {
            ...
            const respuestaUsuarios: UsuarioGitInterface =
                respuesta.data;
    ...
    async obtenerSiguiendoA(
        ...
        if (!CONFIGURACION.offline) {
            ...
            const respuestaSiguiendoA: Number =
                respuesta.data;
    ...
    async obtenerGist(
        ...
        if (!CONFIGURACION.offline) {
            ...
            const respuestaGistUsuarios: GistInterface[] =
                respuesta.data;
            ...
            return [
                {
                    ...
                    'git_pull_url': 'https://gist.github.com/9f0eff456d87f8caf5aee5147ef0ba6c.git',
                    'git_push_url': 'https://gist.github.com/9f0eff456d87f8caf5aee5147ef0ba6c.git',
    ...
    async obtenerReposSuscritos(
        ...
        if (!CONFIGURACION.offline) {
            ...
            const respuestaUsuarios: RepositorioInterface[] =
                respuesta.data;
            return respuestaUsuarios
        } else {
            return [{
